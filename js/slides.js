const slides01 = [
  ...
  },
  {
    ...
    content: `
      ...
      barrio de Kensington en Filadelfia. Por décadas, La Finquita brindó una
  ...
  },
  {
    ...
    content: `
      ...
      <br></br>
      Al pasar al frente de La Finquita hoy en día, uno no pensaría que este
  ...
  },
  {
    ...
    content: `
      La Finquita es solo uno de los más de <b>27,000</b> lotes baldíos a lo
      largo de Filadelfia, muchos de los cuáles sirven una variedad de
      propósitos preciados en su comunidad, desde jardines urbanos a parques
      públicos a pequeños patios colindantes.
      ...
      estado realizando ejecuciones hipotecarias sobre propiedades baldías al
      por mayor, vendiéndolas a la fuerza a través de subastas públicas.
      <br></br>Frecuentemente, los vecinos que han cuidado de estas propiedades
      por años no se enteran que están en venta hasta ya han sido compradas.
      `,
    phase: 'vacant',
    // showpopups: true,
    bounds: [[39.9, -75.35], [40.16, -74.87]],
...
const slides02 = [
  {
    ...
    content: `
      ...
      <b>27 mil</b>, o <b>4,71%</b> estaban baldías en el año 2021.
      `,
    phase: 'vacant',
    // showpopups: true,
    bounds: [[39.9, -75.35], [40.16, -74.87]],
  ...
  },
  {
    ...
    content: `
      ...
      <b>7500</b> propiedades a lo largo de Filadelfia están en riesgo de
  ...
  },
  {
    ...
    content: `
      ...
      Para complicar aún más el asunto, más de 1500 propiedades baldías están
      comprometidas con deudas obligadas al U.S. Bank. <br></br> A finales de la
      década de 1990, la Ciudad de Filadelfia enfrentó una crisis en el
      financiamiento de sus escuelas, así que, en una movida desesperada para
      obtener liquidez, combinó y titulizó miles de gravámenes fiscales y los
  ...
  },
  {
    ...
    content: `
      ...
      luego de la crisis de hipotecas ‘subprime’ de 2008, aumentando junto con
      la ola del mercado de bienes raíces en general. A pesar de la reciente
      caída en ventas de alguacil durante la pandemia del coronavirus, esta
      tendencia será pasajera, ya que las ventas han sido puestas en línea,
      expandiendo enormemente la cantidad de posibles compradores.
      <br></br>
...
const slides03 = [
  ...
  },
  {
    ...
    content: `
      ...
      hipotecaria de 2008, antes de reestablecerse cerca de 2012 a los niveles
      previos.
      `,
    phase: 'permits',
    year: 2007,
  ...
  },
  {
    ...
    content: `
      ...
      a la crisis, llegando a <b>2521</b>.
      <br></br>
      En ese momento, el desarrollo se concentraba alrededor de tres focos en
      las afueras del centro de la ciudad: el área de Graduate Hospital-Point
      Breeze al sureste, los barrios de Northern Liberties-Fishtown al noreste,
      y el área al oeste de Broad Street, entre Fairmount y Cecil B. Moore
      Avenue.
      `,
    phase: 'permits',
    year: 2012,
  ...
  },
  {
    ...
    content: `
      ...
      se expandió hacia afuera, desde los focos antes mencionados hacia los
      barrios de Kensington, Point Breeze y Fairmount.
      <br></br>
...
const slides04 = [
  ...
  },
  {
    ...
    content: `
      ...
      que aquellas con un ingreso por encima de la media.
      <br></br>
      Estos patrones demográficos muestran que cuando la Ciudad de Filadelfia o
  ...
  },
  {
    ...
    content: `
      ...
      comenzado a desbordarse desde otros barrios con intensa actividad en el
  ...
  },
  {
    ...
    content: `
      ...
      utilizados por los vecinos de esta comunidad han empezado a recibir
      presión externa.
      <br></br>
      Los jardines comunitarios en Kensington son un ejemplo cautivador de esto.
      <br></br>
      La Finquita, el jardín comunitario donde comenzó nuestra historia, era
  ...
  },
  {
    ...
    content: `
      ...
      este jardín comunitario ha sido el sitio de una larga campaña vecinal por
      preservar su uso comunal. Este esfuerzo continúa en curso desde que el
      sitio fue parcialmente comprado por un desarrollador privado y ahora está
      en riesgo de ser clausurado.
      <br></br>
